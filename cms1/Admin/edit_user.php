        ...
        <li class="breadcrumb-item" aria-current="page"><a href="index.php">
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $error = "All (*) fields are Required";
                                ...
                                $update_query = "UPDATE `users` SET `date` = '1234567891', `first_name` = '$first_name', `last_name` = '$last_name', `image` = '$image', `role` = '$role', `details` = '$details'";
                                ...
                                if(mysqli_query($connection,$update_query)){
                                    ...
                                    header("refresh:1; url=edit_user.php?edit=$edit_id");
                                    if(!empty($image)){
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" id="role" class="form-control">
                                    <option value="author" <?php if($edit_role == 'author'){
